...
describe('Obtiene y parsea correctamente la situacion tributaria de SII de Haulmer', () => {
    ...
    test('Debe tener la actividad de actividades de consultoria en 2017', () => {
        ...
        const actividadConsultoria = situacionTributaria.actividades!.find((actividad) => actividad.codigo === actividadConsultoriaCodigo);
    ...
    test('Debe tener prorroga por zona de catastrofe en 2017-2018', () => {
        ...
        const prorrogaZonaCatastrofe = situacionTributaria.documentosAutorizadosFormatoNoElectronico!.find((documento) => documento.documento === textoProrroga);
    ...
    test('Debe tener timbres de boletaa electronica con un año asociado', () => {
        ...
        const timbreBoletaElectronica = situacionTributaria.documentosTimbrados!.find((documento) => documento.documento === textoBoleta);
