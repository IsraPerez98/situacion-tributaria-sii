...
function getAutorizadoMonedaExtranjera(contenedorElement: HTMLElement): boolean {
    ...
    return autorizadoMonedaExtranjeraElement.text.trim() !== "Contribuyente autorizado para declarar y pagar sus impuestos en moneda extranjera: NO";
}
 ...
 */
function getDocumentosAutorizadosFormatoNoElectronico(contenedorElement: HTMLElement): DocumentoAutorizadoFormatoNoEletronico[] {
    const documentosAutorizadosFormatoNoElectronicoTablaElement = contenedorElement.querySelectorAll('table.tabla').find((element) => {
    ...
    const documentosAutorizadosFormatoNoElectronicoRowsElements = documentosAutorizadosFormatoNoElectronicoTablaElement.querySelectorAll('tr');

    if(!documentosAutorizadosFormatoNoElectronicoRowsElements || documentosAutorizadosFormatoNoElectronicoRowsElements.length < 2) {
        return [];
    }
